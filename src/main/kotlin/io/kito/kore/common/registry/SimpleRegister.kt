 ...
 * This class extends [AutoRegister] and provides a convenient way to register objects
...
open class SimpleRegister<T>(private val register: DeferredRegister<T>, override val id: String) : AutoRegister {
     ...
     * @param registry The [Registry] to register objects with.
     */
     ...
     * @param id The mod ID or namespace.
     * @param resourceKey The [ResourceKey] of the [Registry] to register objects with.
     */
    constructor(id: String, resourceKey: ResourceKey<Registry<T>>):
            this(DeferredRegister.create(resourceKey, id), id)

    /**
     * Operator function to register a new object with the given name and supplier.
     ...
     * This method is called by Kore during mod initialization to register all defined objects.
     *
