...
/**
 * An interface for classes that can automatically addEntry themselves with NeoForge.
 * Implementations of this interface provide a standardized way for Kore to discover
 * and addEntry various mod components (e.g., blocks, items, fluid types) during initialization.
 */
interface AutoRegister {
     ...
     * @param bus The [IEventBus] to addEntry with (e.g., the Mod Event Bus).
     */
